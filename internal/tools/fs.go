...
func (f *FS) readTool() Tool {
	return Tool{
		...
		Desc: "Read an existing file and return its contents with line numbers. Use this " +
			"before editing; use glob for directory or filename discovery. Use a focused but " +
			"sufficiently large window: prefer one read of up to about 2000 lines over many " +
			"tiny slices, do not reread unchanged sections, and act once the target and " +
			"surrounding pattern are clear. " +
